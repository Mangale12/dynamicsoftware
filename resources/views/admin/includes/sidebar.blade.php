<nav class="sidebar dark_sidebar">
    <div class="logo d-flex justify-content-between">
        <a class="large_logo" href="index.html"><img src="public/admin/img/logo_white.png" alt></a>
        <a class="small_logo" href="index.html"><img src="public/admin/img/mini_logo.png" alt></a>
    ...
    <ul id="sidebar_menu">
        <li class>
            <a href="{{ route('dashboard') }}" aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="public/admin/img/menu-icon/1.svg" alt>
                </div>
                <div class="nav_title">
                    <span>Dashboard </span>
                </div>
        ...
        <li class>
            ...
            <ul>
                ...
                <li><a href="{{ route('gallery.create') }}">Add New Photoes</a></li>
